...
## Legacy Edition
This version only exists because some people reported issues with the newer version; therefore, this version will not be receiving updates and should only be used if you are experiencing issues with the regular version.
